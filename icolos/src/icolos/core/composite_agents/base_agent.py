...
class AgentHeaderParameters(BaseModel):
    ...
    environment: Optional[AgentEnvironmentParameters] = None
...
class BaseAgent(BaseModel):
    ...
    def _nested_update(self, inp: dict[str, Any], pattern: str, replacement: str):
    ...
    def _update_global_variables(self, conf: dict[str, Any]) -> dict[str, Any]:
        conf = deepcopy(conf)
