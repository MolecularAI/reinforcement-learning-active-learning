...
from icolos.core.workflow_steps.gromacs.postprocess import StepGMXPostProcess
...
from icolos.core.workflow_steps.calculation.generic_score import StepGenericScore
...
class StepInitializationEnum:
    ...
    STEP_INIT_DICT = {
        ...
        _SBE.STEP_GENERIC_SCORE: StepGenericScore,
        ...
        _SBE.STEP_GMX_POST: StepGMXPostProcess,
