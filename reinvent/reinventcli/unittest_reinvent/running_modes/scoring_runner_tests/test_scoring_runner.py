...
from unittest_reinvent.fixtures.test_config import MAIN_TEST_PATH
...
class TestScoringRunner(unittest.TestCase):
    ...
    def test_scoring_runner(self):
        ...
        self.assertListEqual(["smiles", "total_score", "tanimoto_similarity", "matching_substructure_name",
                              "raw_tanimoto_similarity", "valid"],
                             list(df.columns))
