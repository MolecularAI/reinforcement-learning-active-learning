...
class TestMolformerCurriculumLearning(unittest.TestCase):
    ...
    def _create_configuration(self, smiles):
        ...
        #TODO:
        curriculum_inception = None
        learning_strategy = LearningStrategyConfiguration(parameters={"sigma": 120}, name=self.learning_strategy_enum.DAP_MOLFORMER)

        curriculum_config = CurriculumStrategyInputConfiguration(name=self.cs_enum.MOLFORMER,
                                                                 input=smiles,
