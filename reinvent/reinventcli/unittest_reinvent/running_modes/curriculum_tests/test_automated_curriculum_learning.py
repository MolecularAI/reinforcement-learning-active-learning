...
from unittest_reinvent.fixtures.test_config import MAIN_TEST_PATH, PRIOR_PATH
...
class TestAutomatedCurriculumLearning(unittest.TestCase):
    ...
    def _create_configuration(self, smiles):
        ...
        curriculum_config = CurriculumStrategyInputConfiguration(name=self.cs_enum.STANDARD,
