...
from unittest_reinvent.fixtures.test_config import MAIN_TEST_PATH, SMILES_SET_PATH, PRIOR_PATH
...
class TestTransferLearning(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.workfolder = os.path.join(MAIN_TEST_PATH, mt_enum.DEFAULT + rm_enum.TRANSFER_LEARNING)
