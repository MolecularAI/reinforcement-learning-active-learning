...
class ScoringFunctionFactory:
    def __new__(cls, sf_parameters: ScoringFunctionParameters) -> BaseScoringFunction:
        ...
        scoring_function_registry = {enum.CUSTOM_PRODUCT: CustomProduct, enum.CUSTOM_SUM: CustomSum}
        return cls.create_scoring_function_instance(sf_parameters, scoring_function_registry)

    @staticmethod
    def create_scoring_function_instance(
        sf_parameters: ScoringFunctionParameters, scoring_function_registry: dict
    ) -> BaseScoringFunction:
        """Returns a scoring method instance"""
