...
class TanimotoSimilarity(BaseScoreComponent):
    ...
    def calculate_score(self, molecules: List) -> ComponentSummary:
        ...
        scores = self._similarity.calculate_tanimoto(query_fps, self._ref_fingerprints)
        ...
        score_summary = ComponentSummary(total_score=transformed_scores, parameters=self.parameters,
                                         raw_score=scores)
