...
def get_score(
    mol, score, sim_func_name_set, shape_weight, color_weight, neg_prot_file, neg_lig_file
):
    neg_score = 0.0
    ...
    best_score = ((shape_weight * best_score_shape) + (color_weight * best_score_color)) / (
...
def penalise_neg_volume(score, neg_score):
    ...
    # Assuming that even a low value is unacceptable, a different penalty method should be considered
