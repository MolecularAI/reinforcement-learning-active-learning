...
from reinvent_scoring.scoring.score_components.active_learning import *
from reinvent_scoring.scoring.score_components.console_invoked.external_process import (
    ExternalProcess,
)
